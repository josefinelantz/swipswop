...
// 			//Require that the orderId is valid
// 			require(_id > 0 && _id <= orderCount);
// 			//Check order not cancelled or filled already
// 			require(!orderFilled[_id]);
// 			require(!orderCancelled[_id]);
// 			// Fetch the order
// 			_Order storage _order = orders[_id];
// 			if (tokens[_order.tokenGet === ETHER) {
...
// 			// Execute trade
// 			// msg.sender fills the order that the user created
// 			// Fee deducted from _amountGet - Charge fees
